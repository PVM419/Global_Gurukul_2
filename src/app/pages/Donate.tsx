...
export default function Donate() {
  ...
  const upiId = "vaydicmath53042@sbi";
              ...
              <>
                {isMobile ? (
                  <>
                    ...
                    <button
                      onClick={copyUpi}
                      className="mt-6 px-6 py-3 bg-[var(--saffron)] text-white rounded-full shadow hover:scale-105 transition"
                    >
                      Copy UPI ID
                    </button>

                    <p className="mt-6 text-[var(--maroon-dark)]">
                      Paste this UPI ID in your UPI app and complete the donation.
                    </p>
                  </>
                ) : (
                  <>
                ...
                <button
                  onClick={() => setStep("complete")}
                  className="mt-8 px-6 py-3 bg-[var(--saffron)] text-white rounded-full shadow hover:scale-105 transition"
                >
                  I Have Paid
                </button>
              </>
